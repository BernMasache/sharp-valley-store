  ...
  return (
    <div className="bg-white py-16 px-6 lg:px-8">
      <div className="mx-auto max-w-7xl text-base leading-7 text-gray-700">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Travel</h1>
        <p className="mt-6 text-xl leading-8">
          Sharp valley holdings provides travel and accommodation services at major conferences around the world.
        </p>
