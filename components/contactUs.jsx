        ...
        <div className="relative">
          <div className="relative overflow-hidden bg-sky-300 py-24 px-8 shadow-2xl lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-16">
            ...
            <div className="relative lg:col-span-1">
              ...
              <h2 className="text-3xl text-gray-700 font-bold tracking-tight sm:text-4xl">Contact Us</h2>
        ...
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden bg-sky-700 py-10 px-6 sm:px-10 xl:p-12">
              ...
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">+1 (972) 504 3766</span>
                </dd>
                <dt>
            ...
            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              ...
              <form onSubmit={sendEmailFunction} className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                <div>
                ...
                <div className="sm:col-span-2 sm:flex sm:justify-end">
                  <button
                    type="submit"
                    className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-sky-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"
                  >
                    Submit
                  </button>
                </div>
